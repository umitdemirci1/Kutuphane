<?php session_start(); if (isset($_SESSION["KullaniciAdi"])) { ?>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i>Kitap Verilecek Üye</h3>
					<ol class="breadcrumb">
						...
						<form class="form-horizontal" method="get">
						  ...
						  <form class="form-horizontal" method="get">
							...
							<div class="form-group">
								  ...
								  <div class="col-sm-6">
									  <input type="text" name="aranan_kelime"
									  value="<?php echo $aranan_kelime; ?>" required class="form-control">
								  </div>
							</div>					
							<div class="col-lg-8">
							<button style="float:right;" type="submit" class="btn btn-primary">Üyeyi Bul</button>  
						 ...
						 <table class="table table-striped table-advance table-hover">
                           <tbody>
							...
							<?php
								...
								WHERE OgrenciTc=? and KitapDurum=1");
								$aldigikitaplar->execute(array($OgrenciTc));
							...
							?>
                                 ...
                                 <td>
                                 <a class="btn btn-success" href="verilecek_kitap_sec.php?OgrenciAdi=<?php echo $gelenler['OgrenciAdi'];?>&OgrenciTc=<?php echo $OgrenciTc; ?>">Üyeyi Seç</a>                           
                                  </td>
                              </tr>  
                              <?php } ?>                            
                           </tbody>
